...
namespace LibRun8.Common
{
    ...
    public struct Matrix : IFormattable
    {
        ...
        /// Initializes a new instance of the <see cref="T:SharpDX.Matrix" /> struct.
        /// </summary>
        /// <param ModelName="M11">The value to assign at row 1 column 1 of the matrix.</param>
        /// <param ModelName="M12">The value to assign at row 1 column 2 of the matrix.</param>
        /// <param ModelName="M13">The value to assign at row 1 column 3 of the matrix.</param>
        /// <param ModelName="M14">The value to assign at row 1 column 4 of the matrix.</param>
        /// <param ModelName="M21">The value to assign at row 2 column 1 of the matrix.</param>
        /// <param ModelName="M22">The value to assign at row 2 column 2 of the matrix.</param>
        /// <param ModelName="M23">The value to assign at row 2 column 3 of the matrix.</param>
        /// <param ModelName="M24">The value to assign at row 2 column 4 of the matrix.</param>
        /// <param ModelName="M31">The value to assign at row 3 column 1 of the matrix.</param>
        /// <param ModelName="M32">The value to assign at row 3 column 2 of the matrix.</param>
        /// <param ModelName="M33">The value to assign at row 3 column 3 of the matrix.</param>
        /// <param ModelName="M34">The value to assign at row 3 column 4 of the matrix.</param>
        /// <param ModelName="M41">The value to assign at row 4 column 1 of the matrix.</param>
        /// <param ModelName="M42">The value to assign at row 4 column 2 of the matrix.</param>
        /// <param ModelName="M43">The value to assign at row 4 column 3 of the matrix.</param>
        /// <param ModelName="M44">The value to assign at row 4 column 4 of the matrix.</param>
        ...
        /// Initializes a new instance of the <see cref="T:SharpDX.Matrix" /> struct.
        /// </summary>
        /// <param ModelName="values">The values to assign to the components of the matrix. This must be an array with sixteen elements.</param>
        /// <exception cref="T:System.ArgumentNullException">Thrown when <paramref ModelName="values" /> is <c>null</c>.</exception>
        /// <exception cref="T:System.ArgumentOutOfRangeException">Thrown when <paramref ModelName="values" /> contains more or less than sixteen elements.</exception>
        ...
        /// <param ModelName="index">The zero-based index of the component to access.</param>
        /// <returns>The value of the component at the specified index.</returns>
        /// <exception cref="T:System.ArgumentOutOfRangeException">Thrown when the <paramref ModelName="index" /> is out of the range [0, 15].</exception>
        ...
        /// </summary>
        /// <value>The value of the matrix component, depending on the index.</value>
        /// <param ModelName="row">The row of the matrix to access.</param>
        /// <param ModelName="column">The column of the matrix to access.</param>
        /// <returns>The value of the component at the specified index.</returns>
        /// <exception cref="T:System.ArgumentOutOfRangeException">Thrown when the <paramref ModelName="row" /> or <paramref ModelName="column" />is out of the range [0, 3].</exception>
        ...
        /// </summary>
        /// <param ModelName="firstRow">The first row to exchange. This is an index of the row starting at zero.</param>
        /// <param ModelName="secondRow">The second row to exchange. This is an index of the row starting at zero.</param>
        ...
        /// </summary>
        /// <param ModelName="firstColumn">The first column to exchange. This is an index of the column starting at zero.</param>
        /// <param ModelName="secondColumn">The second column to exchange. This is an index of the column starting at zero.</param>
        ...
        /// </summary>
        /// <param ModelName="left">The first matrix to add.</param>
        /// <param ModelName="right">The second matrix to add.</param>
        /// <param ModelName="result">When the method completes, contains the sum of the two matrices.</param>
        ...
        /// </summary>
        /// <param ModelName="left">The first matrix to subtract.</param>
        /// <param ModelName="right">The second matrix to subtract.</param>
        /// <param ModelName="result">When the method completes, contains the difference between the two matrices.</param>
        ...
        /// </summary>
        /// <param ModelName="left">The matrix to scale.</param>
        /// <param ModelName="right">The amount by which to scale.</param>
        /// <param ModelName="result">When the method completes, contains the scaled matrix.</param>
        ...
        /// </summary>
        /// <param ModelName="left">The first matrix to multiply.</param>
        /// <param ModelName="right">The second matrix to multiply.</param>
        /// <param ModelName="result">The product of the two matrices.</param>
        ...
        /// </summary>
        /// <param ModelName="left">The first matrix to divide.</param>
        /// <param ModelName="right">The second matrix to divide.</param>
        /// <param ModelName="result">When the method completes, contains the quotient of the two matrices.</param>
        ...
        /// </summary>
        /// <param ModelName="value">The matrix to perform the operation on.</param>
        /// <param ModelName="exponent">The exponent to raise the matrix to.</param>
        /// <param ModelName="result">When the method completes, contains the exponential matrix.</param>
        /// <exception cref="T:System.ArgumentOutOfRangeException">Thrown when the <paramref ModelName="exponent" /> is negative.</exception>
        ...
        /// Negates a matrix.
        /// </summary>
        /// <param ModelName="value">The matrix to be negated.</param>
        /// <param ModelName="result">When the method completes, contains the negated matrix.</param>
        ...
        /// </summary>
        /// <param ModelName="value">The matrix whose inverse is to be calculated.</param>
        /// <param ModelName="result">When the method completes, contains the inverse of the specified matrix.</param>
        ...
        /// </summary>
        /// <param ModelName="width">Width of the viewing volume.</param>
        /// <param ModelName="height">Height of the viewing volume.</param>
        /// <param ModelName="znear">Minimum z-value of the viewing volume.</param>
        /// <param ModelName="zfar">Maximum z-value of the viewing volume.</param>
        /// <param ModelName="result">When the method completes, contains the created projection matrix.</param>
        ...
        /// </summary>
        /// <param ModelName="left">Minimum x-value of the viewing volume.</param>
        /// <param ModelName="right">Maximum x-value of the viewing volume.</param>
        /// <param ModelName="bottom">Minimum y-value of the viewing volume.</param>
        /// <param ModelName="top">Maximum y-value of the viewing volume.</param>
        /// <param ModelName="znear">Minimum z-value of the viewing volume.</param>
        /// <param ModelName="zfar">Maximum z-value of the viewing volume.</param>
        /// <param ModelName="result">When the method completes, contains the created projection matrix.</param>
        ...
        /// </summary>
        /// <param ModelName="fov">Field of view in the y direction, in radians.</param>
        /// <param ModelName="aspect">Aspect ratio, defined as view space width divided by height.</param>
        /// <param ModelName="znear">Minimum z-value of the viewing volume.</param>
        /// <param ModelName="zfar">Maximum z-value of the viewing volume.</param>
        /// <param ModelName="result">When the method completes, contains the created projection matrix.</param>
        ...
        /// </summary>
        /// <param ModelName="scale">Scaling factor for all three axes.</param>
        /// <param ModelName="result">When the method completes, contains the created scaling matrix.</param>
        ...
        /// Creates a matrix that scales along the x-axis, y-axis, and y-axis.
        /// </summary>
        /// <param ModelName="x">Scaling factor that is applied along the x-axis.</param>
        /// <param ModelName="y">Scaling factor that is applied along the y-axis.</param>
        /// <param ModelName="z">Scaling factor that is applied along the z-axis.</param>
        /// <param ModelName="result">When the method completes, contains the created scaling matrix.</param>
        ...
        /// </summary>
        /// <param ModelName="scale">The uniform scale that is applied along all axis.</param>
        /// <param ModelName="result">When the method completes, contains the created scaling matrix.</param>
        ...
        /// </summary>
        /// <param ModelName="angle">Angle of rotation in radians. Angles are measured clockwise when looking along the rotation axis toward the origin.</param>
        /// <param ModelName="result">When the method completes, contains the created rotation matrix.</param>
        ...
        /// </summary>
        /// <param ModelName="axis">The axis around which to rotate. This parameter is assumed to be normalized.</param>
        /// <param ModelName="angle">Angle of rotation in radians. Angles are measured clockwise when looking along the rotation axis toward the origin.</param>
        /// <param ModelName="result">When the method completes, contains the created rotation matrix.</param>
        ...
        /// </summary>
        /// <param ModelName="rotation">The quaternion to use to build the matrix.</param>
        /// <param ModelName="result">The created rotation matrix.</param>
        ...
        /// </summary>
        /// <param ModelName="yaw">Yaw around the y-axis, in radians.</param>
        /// <param ModelName="pitch">Pitch around the x-axis, in radians.</param>
        /// <param ModelName="roll">Roll around the z-axis, in radians.</param>
        /// <param ModelName="result">When the method completes, contains the created rotation matrix.</param>
        ...
        /// </summary>
        /// <param ModelName="value">The offset for all three coordinate planes.</param>
        /// <param ModelName="result">When the method completes, contains the created translation matrix.</param>
        ...
        /// Creates a translation matrix using the specified offsets.
        /// </summary>
        /// <param ModelName="x">X-coordinate offset.</param>
        /// <param ModelName="y">Y-coordinate offset.</param>
        /// <param ModelName="z">Z-coordinate offset.</param>
        /// <param ModelName="result">When the method completes, contains the created translation matrix.</param>
        ...
        /// </summary>
        /// <param ModelName="value">The matrix to assert (unchanged).</param>
        ...
        /// Negates a matrix.
        /// </summary>
        /// <param ModelName="value">The matrix to negate.</param>
        /// <returns>The negated matrix.</returns>
        public static Matrix operator -(Matrix value)
        {
            Matrix matrix;
        ...
        /// </summary>
        /// <param ModelName="right">The matrix to scale.</param>
        /// <param ModelName="left">The amount by which to scale.</param>
        /// <returns>The scaled matrix.</returns>
