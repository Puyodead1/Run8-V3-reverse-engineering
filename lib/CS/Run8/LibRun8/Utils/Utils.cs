...
namespace LibRun8.Util
{
    public static class Utils
    {
        ...
        /// </summary>
        /// <param ModelName="degree">The value to convert.</param>
        ...
        /// </summary>
        /// <param ModelName="value">The value.</param>
        /// <param ModelName="min">The min.</param>
        /// <param ModelName="max">The max.</param>
        ...
        /// </remarks>
        /// <param ModelName="from">Value to interpolate from.</param>
        /// <param ModelName="to">Value to interpolate to.</param>
        /// <param ModelName="amount">Interpolation amount.</param>
        ...
        /// See remarks.
        /// </summary>
        /// <param ModelName="a">The left value to compare.</param>
        /// <param ModelName="b">The right value to compare.</param>
